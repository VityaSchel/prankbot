...
const useUtilityClasses$h = (ownerState) => {
  ...
  const slots = {
    root: ["root", `color${capitalize(color2)}`, disabled && "disabled", error2 && "error", fullWidth && "fullWidth", focused && "focused", formControl && "formControl", size === "small" && "sizeSmall", multiline && "multiline", startAdornment && "adornedStart", endAdornment && "adornedEnd", hiddenLabel && "hiddenLabel", readOnly && "readOnly"],
  ...
  return /* @__PURE__ */ jsxs(React.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, /* @__PURE__ */ jsxs(Root, _extends$1({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, /* @__PURE__ */ jsx(FormControlContext$1.Provider, {
        value: null,
        children: /* @__PURE__ */ jsx(Input3, _extends$1({
          ownerState,
...
const _excluded$7 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "slotProps", "slots", "theme"];
...
const _excluded$6 = ["onEntering"], _excluded2$1 = ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps"];
...
const _excluded$5 = ["onEntering"], _excluded2 = ["autoFocus", "children", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant"];
const RTL_ORIGIN = {
  vertical: "top",
  horizontal: "right"
};
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx(TextField$1, {
      ...
      inputProps: {
        onKeyDown: (e2) => {
          if (e2.key === "Enter") {
            onEnter == null ? void 0 : onEnter(e2);
          }
        }
      },
      className: styles$3.textField,
      error: Boolean(error2),
      ...textFieldProps
    }), error2 && /* @__PURE__ */ jsx("div", {
      className: styles$3.error,
      children: /* @__PURE__ */ jsx(FormHelperText$1, {
        error: true,
        children: error2
      })
    })]
